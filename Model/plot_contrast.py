...
major_radius, stokes, wavelength_vector, linearly_polarised = get_stokes_components(spectral_full, resolution_full)

wavelength_nm = wavelength_vector/10

contrasts, total_polarised, phi_total = find_optimal_crystal(wavelength_nm, stokes, channel_full,delay_thickness, delay_cut_angle, displacer_thickness, displacer_cut_angle)
